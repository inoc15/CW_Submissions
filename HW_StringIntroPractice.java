...
public class HW_StringIntroPractice 
{
	 ...
	 */
	public static String findTheE(String e)
	{
		return("The index of the first letter e is "+e.indexOf("e"));
	}
	 ...
	 */
	public static String getLength(String l)
	{
		return("The amount of characters in this word is "+l.length());
	}
